...
void nvnLoadCPPProcs(Device* device, DeviceGetProcAddressFunc getProc) {
    pfncpp_nvnDeviceBuilderSetDefaults =
        (DeviceBuilderSetDefaultsFunc)getProc(device, "nvnDeviceBuilderSetDefaults");
    pfncpp_nvnDeviceBuilderSetFlags =
        (DeviceBuilderSetFlagsFunc)getProc(device, "nvnDeviceBuilderSetFlags");
    pfncpp_nvnDeviceBuilderGetFlags =
        (DeviceBuilderGetFlagsFunc)getProc(device, "nvnDeviceBuilderGetFlags");
    ...
    pfncpp_nvnDeviceSetDebugLabel =
        (DeviceSetDebugLabelFunc)getProc(device, "nvnDeviceSetDebugLabel");
    pfncpp_nvnDeviceGetProcAddress =
        (DeviceGetProcAddressFunc)getProc(device, "nvnDeviceGetProcAddress");
    pfncpp_nvnDeviceGetInteger = (DeviceGetIntegerFunc)getProc(device, "nvnDeviceGetInteger");
    pfncpp_nvnDeviceGetCurrentTimestampInNanoseconds =
        (DeviceGetCurrentTimestampInNanosecondsFunc)getProc(
    ...
    pfncpp_nvnDeviceGetTextureHandle =
        (DeviceGetTextureHandleFunc)getProc(device, "nvnDeviceGetTextureHandle");
    pfncpp_nvnDeviceGetTexelFetchHandle =
        (DeviceGetTexelFetchHandleFunc)getProc(device, "nvnDeviceGetTexelFetchHandle");
    pfncpp_nvnDeviceGetImageHandle =
        (DeviceGetImageHandleFunc)getProc(device, "nvnDeviceGetImageHandle");
    pfncpp_nvnDeviceInstallDebugCallback =
        (DeviceInstallDebugCallbackFunc)getProc(device, "nvnDeviceInstallDebugCallback");
    pfncpp_nvnDeviceGenerateDebugDomainId =
        (DeviceGenerateDebugDomainIdFunc)getProc(device, "nvnDeviceGenerateDebugDomainId");
    pfncpp_nvnDeviceSetWindowOriginMode =
        (DeviceSetWindowOriginModeFunc)getProc(device, "nvnDeviceSetWindowOriginMode");
    pfncpp_nvnDeviceSetDepthMode = (DeviceSetDepthModeFunc)getProc(device, "nvnDeviceSetDepthMode");
    pfncpp_nvnDeviceRegisterFastClearColor =
        (DeviceRegisterFastClearColorFunc)getProc(device, "nvnDeviceRegisterFastClearColor");
    pfncpp_nvnDeviceRegisterFastClearColori =
        (DeviceRegisterFastClearColoriFunc)getProc(device, "nvnDeviceRegisterFastClearColori");
    pfncpp_nvnDeviceRegisterFastClearColorui =
        (DeviceRegisterFastClearColoruiFunc)getProc(device, "nvnDeviceRegisterFastClearColorui");
    pfncpp_nvnDeviceRegisterFastClearDepth =
        (DeviceRegisterFastClearDepthFunc)getProc(device, "nvnDeviceRegisterFastClearDepth");
    pfncpp_nvnDeviceGetWindowOriginMode =
        (DeviceGetWindowOriginModeFunc)getProc(device, "nvnDeviceGetWindowOriginMode");
    pfncpp_nvnDeviceGetDepthMode = (DeviceGetDepthModeFunc)getProc(device, "nvnDeviceGetDepthMode");
    pfncpp_nvnDeviceGetTimestampInNanoseconds =
        (DeviceGetTimestampInNanosecondsFunc)getProc(device, "nvnDeviceGetTimestampInNanoseconds");
    pfncpp_nvnDeviceApplyDeferredFinalizes =
        (DeviceApplyDeferredFinalizesFunc)getProc(device, "nvnDeviceApplyDeferredFinalizes");
    pfncpp_nvnDeviceFinalizeCommandHandle =
        (DeviceFinalizeCommandHandleFunc)getProc(device, "nvnDeviceFinalizeCommandHandle");
    pfncpp_nvnDeviceWalkDebugDatabase =
        (DeviceWalkDebugDatabaseFunc)getProc(device, "nvnDeviceWalkDebugDatabase");
    pfncpp_nvnDeviceGetSeparateTextureHandle =
        (DeviceGetSeparateTextureHandleFunc)getProc(device, "nvnDeviceGetSeparateTextureHandle");
    pfncpp_nvnDeviceGetSeparateSamplerHandle =
        (DeviceGetSeparateSamplerHandleFunc)getProc(device, "nvnDeviceGetSeparateSamplerHandle");
    ...
    pfncpp_nvnQueueGetTotalCommandMemoryUsed =
        (QueueGetTotalCommandMemoryUsedFunc)getProc(device, "nvnQueueGetTotalCommandMemoryUsed");
    pfncpp_nvnQueueGetTotalControlMemoryUsed =
        (QueueGetTotalControlMemoryUsedFunc)getProc(device, "nvnQueueGetTotalControlMemoryUsed");
    pfncpp_nvnQueueGetTotalComputeMemoryUsed =
        (QueueGetTotalComputeMemoryUsedFunc)getProc(device, "nvnQueueGetTotalComputeMemoryUsed");
    pfncpp_nvnQueueResetMemoryUsageCounts =
        (QueueResetMemoryUsageCountsFunc)getProc(device, "nvnQueueResetMemoryUsageCounts");
    pfncpp_nvnQueueBuilderSetDevice =
        (QueueBuilderSetDeviceFunc)getProc(device, "nvnQueueBuilderSetDevice");
    pfncpp_nvnQueueBuilderSetDefaults =
        (QueueBuilderSetDefaultsFunc)getProc(device, "nvnQueueBuilderSetDefaults");
    pfncpp_nvnQueueBuilderSetFlags =
        (QueueBuilderSetFlagsFunc)getProc(device, "nvnQueueBuilderSetFlags");
    ...
    pfncpp_nvnQueueBuilderGetQueueMemorySize =
        (QueueBuilderGetQueueMemorySizeFunc)getProc(device, "nvnQueueBuilderGetQueueMemorySize");
    pfncpp_nvnQueueBuilderSetQueueMemory =
        (QueueBuilderSetQueueMemoryFunc)getProc(device, "nvnQueueBuilderSetQueueMemory");
    pfncpp_nvnQueueBuilderSetCommandFlushThreshold =
        (QueueBuilderSetCommandFlushThresholdFunc)getProc(
            device, "nvnQueueBuilderSetCommandFlushThreshold");
    pfncpp_nvnQueueBuilderGetDevice =
        (QueueBuilderGetDeviceFunc)getProc(device, "nvnQueueBuilderGetDevice");
    pfncpp_nvnQueueBuilderGetFlags =
        (QueueBuilderGetFlagsFunc)getProc(device, "nvnQueueBuilderGetFlags");
    ...
    pfncpp_nvnQueueBuilderGetCommandFlushThreshold =
        (QueueBuilderGetCommandFlushThresholdFunc)getProc(
            device, "nvnQueueBuilderGetCommandFlushThreshold");
    pfncpp_nvnQueueBuilderGetMemorySize =
        (QueueBuilderGetMemorySizeFunc)getProc(device, "nvnQueueBuilderGetMemorySize");
    pfncpp_nvnQueueBuilderGetMemory =
        (QueueBuilderGetMemoryFunc)getProc(device, "nvnQueueBuilderGetMemory");
    ...
    pfncpp_nvnQueueSubmitCommands =
        (QueueSubmitCommandsFunc)getProc(device, "nvnQueueSubmitCommands");
    ...
    pfncpp_nvnQueuePresentTexture =
        (QueuePresentTextureFunc)getProc(device, "nvnQueuePresentTexture");
    pfncpp_nvnQueueAcquireTexture =
        (QueueAcquireTextureFunc)getProc(device, "nvnQueueAcquireTexture");
    pfncpp_nvnWindowBuilderSetDevice =
        (WindowBuilderSetDeviceFunc)getProc(device, "nvnWindowBuilderSetDevice");
    pfncpp_nvnWindowBuilderSetDefaults =
        (WindowBuilderSetDefaultsFunc)getProc(device, "nvnWindowBuilderSetDefaults");
    pfncpp_nvnWindowBuilderSetNativeWindow =
        (WindowBuilderSetNativeWindowFunc)getProc(device, "nvnWindowBuilderSetNativeWindow");
    pfncpp_nvnWindowBuilderSetTextures =
        (WindowBuilderSetTexturesFunc)getProc(device, "nvnWindowBuilderSetTextures");
    pfncpp_nvnWindowBuilderSetPresentInterval =
        (WindowBuilderSetPresentIntervalFunc)getProc(device, "nvnWindowBuilderSetPresentInterval");
    pfncpp_nvnWindowBuilderGetDevice =
        (WindowBuilderGetDeviceFunc)getProc(device, "nvnWindowBuilderGetDevice");
    pfncpp_nvnWindowBuilderGetNumTextures =
        (WindowBuilderGetNumTexturesFunc)getProc(device, "nvnWindowBuilderGetNumTextures");
    pfncpp_nvnWindowBuilderGetTexture =
        (WindowBuilderGetTextureFunc)getProc(device, "nvnWindowBuilderGetTexture");
    pfncpp_nvnWindowBuilderGetNativeWindow =
        (WindowBuilderGetNativeWindowFunc)getProc(device, "nvnWindowBuilderGetNativeWindow");
    pfncpp_nvnWindowBuilderGetPresentInterval =
        (WindowBuilderGetPresentIntervalFunc)getProc(device, "nvnWindowBuilderGetPresentInterval");
    ...
    pfncpp_nvnWindowSetDebugLabel =
        (WindowSetDebugLabelFunc)getProc(device, "nvnWindowSetDebugLabel");
    pfncpp_nvnWindowAcquireTexture =
        (WindowAcquireTextureFunc)getProc(device, "nvnWindowAcquireTexture");
    pfncpp_nvnWindowGetNativeWindow =
        (WindowGetNativeWindowFunc)getProc(device, "nvnWindowGetNativeWindow");
    pfncpp_nvnWindowGetPresentInterval =
        (WindowGetPresentIntervalFunc)getProc(device, "nvnWindowGetPresentInterval");
    pfncpp_nvnWindowSetPresentInterval =
        (WindowSetPresentIntervalFunc)getProc(device, "nvnWindowSetPresentInterval");
    ...
    pfncpp_nvnProgramSetDebugLabel =
        (ProgramSetDebugLabelFunc)getProc(device, "nvnProgramSetDebugLabel");
    pfncpp_nvnProgramSetShaders = (ProgramSetShadersFunc)getProc(device, "nvnProgramSetShaders");
    pfncpp_nvnMemoryPoolBuilderSetDevice =
        (MemoryPoolBuilderSetDeviceFunc)getProc(device, "nvnMemoryPoolBuilderSetDevice");
    pfncpp_nvnMemoryPoolBuilderSetDefaults =
        (MemoryPoolBuilderSetDefaultsFunc)getProc(device, "nvnMemoryPoolBuilderSetDefaults");
    pfncpp_nvnMemoryPoolBuilderSetStorage =
        (MemoryPoolBuilderSetStorageFunc)getProc(device, "nvnMemoryPoolBuilderSetStorage");
    pfncpp_nvnMemoryPoolBuilderSetFlags =
        (MemoryPoolBuilderSetFlagsFunc)getProc(device, "nvnMemoryPoolBuilderSetFlags");
    pfncpp_nvnMemoryPoolBuilderGetDevice =
        (MemoryPoolBuilderGetDeviceFunc)getProc(device, "nvnMemoryPoolBuilderGetDevice");
    pfncpp_nvnMemoryPoolBuilderGetMemory =
        (MemoryPoolBuilderGetMemoryFunc)getProc(device, "nvnMemoryPoolBuilderGetMemory");
    pfncpp_nvnMemoryPoolBuilderGetSize =
        (MemoryPoolBuilderGetSizeFunc)getProc(device, "nvnMemoryPoolBuilderGetSize");
    pfncpp_nvnMemoryPoolBuilderGetFlags =
        (MemoryPoolBuilderGetFlagsFunc)getProc(device, "nvnMemoryPoolBuilderGetFlags");
    pfncpp_nvnMemoryPoolInitialize =
        (MemoryPoolInitializeFunc)getProc(device, "nvnMemoryPoolInitialize");
    pfncpp_nvnMemoryPoolSetDebugLabel =
        (MemoryPoolSetDebugLabelFunc)getProc(device, "nvnMemoryPoolSetDebugLabel");
    ...
    pfncpp_nvnMemoryPoolFlushMappedRange =
        (MemoryPoolFlushMappedRangeFunc)getProc(device, "nvnMemoryPoolFlushMappedRange");
    pfncpp_nvnMemoryPoolInvalidateMappedRange =
        (MemoryPoolInvalidateMappedRangeFunc)getProc(device, "nvnMemoryPoolInvalidateMappedRange");
    pfncpp_nvnMemoryPoolGetBufferAddress =
        (MemoryPoolGetBufferAddressFunc)getProc(device, "nvnMemoryPoolGetBufferAddress");
    pfncpp_nvnMemoryPoolMapVirtual =
        (MemoryPoolMapVirtualFunc)getProc(device, "nvnMemoryPoolMapVirtual");
    ...
    pfncpp_nvnTexturePoolInitialize =
        (TexturePoolInitializeFunc)getProc(device, "nvnTexturePoolInitialize");
    pfncpp_nvnTexturePoolSetDebugLabel =
        (TexturePoolSetDebugLabelFunc)getProc(device, "nvnTexturePoolSetDebugLabel");
    pfncpp_nvnTexturePoolFinalize =
        (TexturePoolFinalizeFunc)getProc(device, "nvnTexturePoolFinalize");
    pfncpp_nvnTexturePoolRegisterTexture =
        (TexturePoolRegisterTextureFunc)getProc(device, "nvnTexturePoolRegisterTexture");
    pfncpp_nvnTexturePoolRegisterImage =
        (TexturePoolRegisterImageFunc)getProc(device, "nvnTexturePoolRegisterImage");
    pfncpp_nvnTexturePoolGetMemoryPool =
        (TexturePoolGetMemoryPoolFunc)getProc(device, "nvnTexturePoolGetMemoryPool");
    pfncpp_nvnTexturePoolGetMemoryOffset =
        (TexturePoolGetMemoryOffsetFunc)getProc(device, "nvnTexturePoolGetMemoryOffset");
    pfncpp_nvnTexturePoolGetSize = (TexturePoolGetSizeFunc)getProc(device, "nvnTexturePoolGetSize");
    pfncpp_nvnSamplerPoolInitialize =
        (SamplerPoolInitializeFunc)getProc(device, "nvnSamplerPoolInitialize");
    pfncpp_nvnSamplerPoolSetDebugLabel =
        (SamplerPoolSetDebugLabelFunc)getProc(device, "nvnSamplerPoolSetDebugLabel");
    pfncpp_nvnSamplerPoolFinalize =
        (SamplerPoolFinalizeFunc)getProc(device, "nvnSamplerPoolFinalize");
    pfncpp_nvnSamplerPoolRegisterSampler =
        (SamplerPoolRegisterSamplerFunc)getProc(device, "nvnSamplerPoolRegisterSampler");
    ...
    pfncpp_nvnSamplerPoolGetMemoryPool =
        (SamplerPoolGetMemoryPoolFunc)getProc(device, "nvnSamplerPoolGetMemoryPool");
    pfncpp_nvnSamplerPoolGetMemoryOffset =
        (SamplerPoolGetMemoryOffsetFunc)getProc(device, "nvnSamplerPoolGetMemoryOffset");
    pfncpp_nvnSamplerPoolGetSize = (SamplerPoolGetSizeFunc)getProc(device, "nvnSamplerPoolGetSize");
    pfncpp_nvnBufferBuilderSetDevice =
        (BufferBuilderSetDeviceFunc)getProc(device, "nvnBufferBuilderSetDevice");
    pfncpp_nvnBufferBuilderSetDefaults =
        (BufferBuilderSetDefaultsFunc)getProc(device, "nvnBufferBuilderSetDefaults");
    pfncpp_nvnBufferBuilderSetStorage =
        (BufferBuilderSetStorageFunc)getProc(device, "nvnBufferBuilderSetStorage");
    pfncpp_nvnBufferBuilderGetDevice =
        (BufferBuilderGetDeviceFunc)getProc(device, "nvnBufferBuilderGetDevice");
    pfncpp_nvnBufferBuilderGetMemoryPool =
        (BufferBuilderGetMemoryPoolFunc)getProc(device, "nvnBufferBuilderGetMemoryPool");
    pfncpp_nvnBufferBuilderGetMemoryOffset =
        (BufferBuilderGetMemoryOffsetFunc)getProc(device, "nvnBufferBuilderGetMemoryOffset");
    pfncpp_nvnBufferBuilderGetSize =
        (BufferBuilderGetSizeFunc)getProc(device, "nvnBufferBuilderGetSize");
    pfncpp_nvnBufferInitialize = (BufferInitializeFunc)getProc(device, "nvnBufferInitialize");
    pfncpp_nvnBufferSetDebugLabel =
        (BufferSetDebugLabelFunc)getProc(device, "nvnBufferSetDebugLabel");
    ...
    pfncpp_nvnBufferFlushMappedRange =
        (BufferFlushMappedRangeFunc)getProc(device, "nvnBufferFlushMappedRange");
    pfncpp_nvnBufferInvalidateMappedRange =
        (BufferInvalidateMappedRangeFunc)getProc(device, "nvnBufferInvalidateMappedRange");
    pfncpp_nvnBufferGetMemoryPool =
        (BufferGetMemoryPoolFunc)getProc(device, "nvnBufferGetMemoryPool");
    pfncpp_nvnBufferGetMemoryOffset =
        (BufferGetMemoryOffsetFunc)getProc(device, "nvnBufferGetMemoryOffset");
    ...
    pfncpp_nvnTextureBuilderSetDevice =
        (TextureBuilderSetDeviceFunc)getProc(device, "nvnTextureBuilderSetDevice");
    pfncpp_nvnTextureBuilderSetDefaults =
        (TextureBuilderSetDefaultsFunc)getProc(device, "nvnTextureBuilderSetDefaults");
    pfncpp_nvnTextureBuilderSetFlags =
        (TextureBuilderSetFlagsFunc)getProc(device, "nvnTextureBuilderSetFlags");
    pfncpp_nvnTextureBuilderSetTarget =
        (TextureBuilderSetTargetFunc)getProc(device, "nvnTextureBuilderSetTarget");
    pfncpp_nvnTextureBuilderSetWidth =
        (TextureBuilderSetWidthFunc)getProc(device, "nvnTextureBuilderSetWidth");
    pfncpp_nvnTextureBuilderSetHeight =
        (TextureBuilderSetHeightFunc)getProc(device, "nvnTextureBuilderSetHeight");
    pfncpp_nvnTextureBuilderSetDepth =
        (TextureBuilderSetDepthFunc)getProc(device, "nvnTextureBuilderSetDepth");
    pfncpp_nvnTextureBuilderSetSize1D =
        (TextureBuilderSetSize1DFunc)getProc(device, "nvnTextureBuilderSetSize1D");
    pfncpp_nvnTextureBuilderSetSize2D =
        (TextureBuilderSetSize2DFunc)getProc(device, "nvnTextureBuilderSetSize2D");
    pfncpp_nvnTextureBuilderSetSize3D =
        (TextureBuilderSetSize3DFunc)getProc(device, "nvnTextureBuilderSetSize3D");
    pfncpp_nvnTextureBuilderSetLevels =
        (TextureBuilderSetLevelsFunc)getProc(device, "nvnTextureBuilderSetLevels");
    pfncpp_nvnTextureBuilderSetFormat =
        (TextureBuilderSetFormatFunc)getProc(device, "nvnTextureBuilderSetFormat");
    pfncpp_nvnTextureBuilderSetSamples =
        (TextureBuilderSetSamplesFunc)getProc(device, "nvnTextureBuilderSetSamples");
    pfncpp_nvnTextureBuilderSetSwizzle =
        (TextureBuilderSetSwizzleFunc)getProc(device, "nvnTextureBuilderSetSwizzle");
    ...
    pfncpp_nvnTextureBuilderGetStorageSize =
        (TextureBuilderGetStorageSizeFunc)getProc(device, "nvnTextureBuilderGetStorageSize");
    ...
    pfncpp_nvnTextureBuilderSetStorage =
        (TextureBuilderSetStorageFunc)getProc(device, "nvnTextureBuilderSetStorage");
    pfncpp_nvnTextureBuilderSetPackagedTextureData =
        (TextureBuilderSetPackagedTextureDataFunc)getProc(
            device, "nvnTextureBuilderSetPackagedTextureData");
    pfncpp_nvnTextureBuilderSetPackagedTextureLayout =
        (TextureBuilderSetPackagedTextureLayoutFunc)getProc(
            device, "nvnTextureBuilderSetPackagedTextureLayout");
    pfncpp_nvnTextureBuilderSetStride =
        (TextureBuilderSetStrideFunc)getProc(device, "nvnTextureBuilderSetStride");
    pfncpp_nvnTextureBuilderSetGLTextureName =
        (TextureBuilderSetGLTextureNameFunc)getProc(device, "nvnTextureBuilderSetGLTextureName");
    pfncpp_nvnTextureBuilderGetStorageClass =
        (TextureBuilderGetStorageClassFunc)getProc(device, "nvnTextureBuilderGetStorageClass");
    pfncpp_nvnTextureBuilderGetDevice =
        (TextureBuilderGetDeviceFunc)getProc(device, "nvnTextureBuilderGetDevice");
    pfncpp_nvnTextureBuilderGetFlags =
        (TextureBuilderGetFlagsFunc)getProc(device, "nvnTextureBuilderGetFlags");
    pfncpp_nvnTextureBuilderGetTarget =
        (TextureBuilderGetTargetFunc)getProc(device, "nvnTextureBuilderGetTarget");
    pfncpp_nvnTextureBuilderGetWidth =
        (TextureBuilderGetWidthFunc)getProc(device, "nvnTextureBuilderGetWidth");
    pfncpp_nvnTextureBuilderGetHeight =
        (TextureBuilderGetHeightFunc)getProc(device, "nvnTextureBuilderGetHeight");
    pfncpp_nvnTextureBuilderGetDepth =
        (TextureBuilderGetDepthFunc)getProc(device, "nvnTextureBuilderGetDepth");
    pfncpp_nvnTextureBuilderGetLevels =
        (TextureBuilderGetLevelsFunc)getProc(device, "nvnTextureBuilderGetLevels");
    pfncpp_nvnTextureBuilderGetFormat =
        (TextureBuilderGetFormatFunc)getProc(device, "nvnTextureBuilderGetFormat");
    pfncpp_nvnTextureBuilderGetSamples =
        (TextureBuilderGetSamplesFunc)getProc(device, "nvnTextureBuilderGetSamples");
    pfncpp_nvnTextureBuilderGetSwizzle =
        (TextureBuilderGetSwizzleFunc)getProc(device, "nvnTextureBuilderGetSwizzle");
    ...
    pfncpp_nvnTextureBuilderGetPackagedTextureData =
        (TextureBuilderGetPackagedTextureDataFunc)getProc(
            device, "nvnTextureBuilderGetPackagedTextureData");
    pfncpp_nvnTextureBuilderGetPackagedTextureLayout =
        (TextureBuilderGetPackagedTextureLayoutFunc)getProc(
            device, "nvnTextureBuilderGetPackagedTextureLayout");
    pfncpp_nvnTextureBuilderGetStride =
        (TextureBuilderGetStrideFunc)getProc(device, "nvnTextureBuilderGetStride");
    ...
    pfncpp_nvnTextureBuilderGetGLTextureName =
        (TextureBuilderGetGLTextureNameFunc)getProc(device, "nvnTextureBuilderGetGLTextureName");
    ...
    pfncpp_nvnTextureBuilderGetMemoryPool =
        (TextureBuilderGetMemoryPoolFunc)getProc(device, "nvnTextureBuilderGetMemoryPool");
    pfncpp_nvnTextureBuilderGetMemoryOffset =
        (TextureBuilderGetMemoryOffsetFunc)getProc(device, "nvnTextureBuilderGetMemoryOffset");
    pfncpp_nvnTextureViewSetDefaults =
        (TextureViewSetDefaultsFunc)getProc(device, "nvnTextureViewSetDefaults");
    pfncpp_nvnTextureViewSetLevels =
        (TextureViewSetLevelsFunc)getProc(device, "nvnTextureViewSetLevels");
    pfncpp_nvnTextureViewSetLayers =
        (TextureViewSetLayersFunc)getProc(device, "nvnTextureViewSetLayers");
    pfncpp_nvnTextureViewSetFormat =
        (TextureViewSetFormatFunc)getProc(device, "nvnTextureViewSetFormat");
    pfncpp_nvnTextureViewSetSwizzle =
        (TextureViewSetSwizzleFunc)getProc(device, "nvnTextureViewSetSwizzle");
    pfncpp_nvnTextureViewSetDepthStencilMode =
        (TextureViewSetDepthStencilModeFunc)getProc(device, "nvnTextureViewSetDepthStencilMode");
    pfncpp_nvnTextureViewSetTarget =
        (TextureViewSetTargetFunc)getProc(device, "nvnTextureViewSetTarget");
    pfncpp_nvnTextureViewGetLevels =
        (TextureViewGetLevelsFunc)getProc(device, "nvnTextureViewGetLevels");
    pfncpp_nvnTextureViewGetLayers =
        (TextureViewGetLayersFunc)getProc(device, "nvnTextureViewGetLayers");
    pfncpp_nvnTextureViewGetFormat =
        (TextureViewGetFormatFunc)getProc(device, "nvnTextureViewGetFormat");
    pfncpp_nvnTextureViewGetSwizzle =
        (TextureViewGetSwizzleFunc)getProc(device, "nvnTextureViewGetSwizzle");
    pfncpp_nvnTextureViewGetDepthStencilMode =
        (TextureViewGetDepthStencilModeFunc)getProc(device, "nvnTextureViewGetDepthStencilMode");
    pfncpp_nvnTextureViewGetTarget =
        (TextureViewGetTargetFunc)getProc(device, "nvnTextureViewGetTarget");
    ...
    pfncpp_nvnTextureGetZCullStorageSize =
        (TextureGetZCullStorageSizeFunc)getProc(device, "nvnTextureGetZCullStorageSize");
    pfncpp_nvnTextureFinalize = (TextureFinalizeFunc)getProc(device, "nvnTextureFinalize");
    pfncpp_nvnTextureSetDebugLabel =
        (TextureSetDebugLabelFunc)getProc(device, "nvnTextureSetDebugLabel");
    pfncpp_nvnTextureGetStorageClass =
        (TextureGetStorageClassFunc)getProc(device, "nvnTextureGetStorageClass");
    pfncpp_nvnTextureGetViewOffset =
        (TextureGetViewOffsetFunc)getProc(device, "nvnTextureGetViewOffset");
    ...
    pfncpp_nvnTextureGetDepthStencilMode =
        (TextureGetDepthStencilModeFunc)getProc(device, "nvnTextureGetDepthStencilMode");
    pfncpp_nvnTextureGetStride = (TextureGetStrideFunc)getProc(device, "nvnTextureGetStride");
    pfncpp_nvnTextureGetTextureAddress =
        (TextureGetTextureAddressFunc)getProc(device, "nvnTextureGetTextureAddress");
    pfncpp_nvnTextureGetSparseTileLayout =
        (TextureGetSparseTileLayoutFunc)getProc(device, "nvnTextureGetSparseTileLayout");
    pfncpp_nvnTextureWriteTexels = (TextureWriteTexelsFunc)getProc(device, "nvnTextureWriteTexels");
    pfncpp_nvnTextureWriteTexelsStrided =
        (TextureWriteTexelsStridedFunc)getProc(device, "nvnTextureWriteTexelsStrided");
    pfncpp_nvnTextureReadTexels = (TextureReadTexelsFunc)getProc(device, "nvnTextureReadTexels");
    pfncpp_nvnTextureReadTexelsStrided =
        (TextureReadTexelsStridedFunc)getProc(device, "nvnTextureReadTexelsStrided");
    pfncpp_nvnTextureFlushTexels = (TextureFlushTexelsFunc)getProc(device, "nvnTextureFlushTexels");
    pfncpp_nvnTextureInvalidateTexels =
        (TextureInvalidateTexelsFunc)getProc(device, "nvnTextureInvalidateTexels");
    pfncpp_nvnTextureGetMemoryPool =
        (TextureGetMemoryPoolFunc)getProc(device, "nvnTextureGetMemoryPool");
    pfncpp_nvnTextureGetMemoryOffset =
        (TextureGetMemoryOffsetFunc)getProc(device, "nvnTextureGetMemoryOffset");
    pfncpp_nvnTextureGetStorageSize =
        (TextureGetStorageSizeFunc)getProc(device, "nvnTextureGetStorageSize");
    ...
    pfncpp_nvnSamplerBuilderSetDevice =
        (SamplerBuilderSetDeviceFunc)getProc(device, "nvnSamplerBuilderSetDevice");
    pfncpp_nvnSamplerBuilderSetDefaults =
        (SamplerBuilderSetDefaultsFunc)getProc(device, "nvnSamplerBuilderSetDefaults");
    pfncpp_nvnSamplerBuilderSetMinMagFilter =
        (SamplerBuilderSetMinMagFilterFunc)getProc(device, "nvnSamplerBuilderSetMinMagFilter");
    pfncpp_nvnSamplerBuilderSetWrapMode =
        (SamplerBuilderSetWrapModeFunc)getProc(device, "nvnSamplerBuilderSetWrapMode");
    pfncpp_nvnSamplerBuilderSetLodClamp =
        (SamplerBuilderSetLodClampFunc)getProc(device, "nvnSamplerBuilderSetLodClamp");
    pfncpp_nvnSamplerBuilderSetLodBias =
        (SamplerBuilderSetLodBiasFunc)getProc(device, "nvnSamplerBuilderSetLodBias");
    pfncpp_nvnSamplerBuilderSetCompare =
        (SamplerBuilderSetCompareFunc)getProc(device, "nvnSamplerBuilderSetCompare");
    pfncpp_nvnSamplerBuilderSetBorderColor =
        (SamplerBuilderSetBorderColorFunc)getProc(device, "nvnSamplerBuilderSetBorderColor");
    pfncpp_nvnSamplerBuilderSetBorderColori =
        (SamplerBuilderSetBorderColoriFunc)getProc(device, "nvnSamplerBuilderSetBorderColori");
    pfncpp_nvnSamplerBuilderSetBorderColorui =
        (SamplerBuilderSetBorderColoruiFunc)getProc(device, "nvnSamplerBuilderSetBorderColorui");
    pfncpp_nvnSamplerBuilderSetMaxAnisotropy =
        (SamplerBuilderSetMaxAnisotropyFunc)getProc(device, "nvnSamplerBuilderSetMaxAnisotropy");
    ...
    pfncpp_nvnSamplerBuilderSetLodSnap =
        (SamplerBuilderSetLodSnapFunc)getProc(device, "nvnSamplerBuilderSetLodSnap");
    pfncpp_nvnSamplerBuilderGetDevice =
        (SamplerBuilderGetDeviceFunc)getProc(device, "nvnSamplerBuilderGetDevice");
    pfncpp_nvnSamplerBuilderGetMinMagFilter =
        (SamplerBuilderGetMinMagFilterFunc)getProc(device, "nvnSamplerBuilderGetMinMagFilter");
    pfncpp_nvnSamplerBuilderGetWrapMode =
        (SamplerBuilderGetWrapModeFunc)getProc(device, "nvnSamplerBuilderGetWrapMode");
    pfncpp_nvnSamplerBuilderGetLodClamp =
        (SamplerBuilderGetLodClampFunc)getProc(device, "nvnSamplerBuilderGetLodClamp");
    pfncpp_nvnSamplerBuilderGetLodBias =
        (SamplerBuilderGetLodBiasFunc)getProc(device, "nvnSamplerBuilderGetLodBias");
    pfncpp_nvnSamplerBuilderGetCompare =
        (SamplerBuilderGetCompareFunc)getProc(device, "nvnSamplerBuilderGetCompare");
    pfncpp_nvnSamplerBuilderGetBorderColor =
        (SamplerBuilderGetBorderColorFunc)getProc(device, "nvnSamplerBuilderGetBorderColor");
    pfncpp_nvnSamplerBuilderGetBorderColori =
        (SamplerBuilderGetBorderColoriFunc)getProc(device, "nvnSamplerBuilderGetBorderColori");
    pfncpp_nvnSamplerBuilderGetBorderColorui =
        (SamplerBuilderGetBorderColoruiFunc)getProc(device, "nvnSamplerBuilderGetBorderColorui");
    pfncpp_nvnSamplerBuilderGetMaxAnisotropy =
        (SamplerBuilderGetMaxAnisotropyFunc)getProc(device, "nvnSamplerBuilderGetMaxAnisotropy");
    ...
    pfncpp_nvnSamplerBuilderGetLodSnap =
        (SamplerBuilderGetLodSnapFunc)getProc(device, "nvnSamplerBuilderGetLodSnap");
    ...
    pfncpp_nvnSamplerSetDebugLabel =
        (SamplerSetDebugLabelFunc)getProc(device, "nvnSamplerSetDebugLabel");
    pfncpp_nvnSamplerGetMinMagFilter =
        (SamplerGetMinMagFilterFunc)getProc(device, "nvnSamplerGetMinMagFilter");
    ...
    pfncpp_nvnSamplerGetBorderColor =
        (SamplerGetBorderColorFunc)getProc(device, "nvnSamplerGetBorderColor");
    pfncpp_nvnSamplerGetBorderColori =
        (SamplerGetBorderColoriFunc)getProc(device, "nvnSamplerGetBorderColori");
    pfncpp_nvnSamplerGetBorderColorui =
        (SamplerGetBorderColoruiFunc)getProc(device, "nvnSamplerGetBorderColorui");
    pfncpp_nvnSamplerGetMaxAnisotropy =
        (SamplerGetMaxAnisotropyFunc)getProc(device, "nvnSamplerGetMaxAnisotropy");
    pfncpp_nvnSamplerGetReductionFilter =
        (SamplerGetReductionFilterFunc)getProc(device, "nvnSamplerGetReductionFilter");
    ...
    pfncpp_nvnBlendStateSetDefaults =
        (BlendStateSetDefaultsFunc)getProc(device, "nvnBlendStateSetDefaults");
    pfncpp_nvnBlendStateSetBlendTarget =
        (BlendStateSetBlendTargetFunc)getProc(device, "nvnBlendStateSetBlendTarget");
    pfncpp_nvnBlendStateSetBlendFunc =
        (BlendStateSetBlendFuncFunc)getProc(device, "nvnBlendStateSetBlendFunc");
    pfncpp_nvnBlendStateSetBlendEquation =
        (BlendStateSetBlendEquationFunc)getProc(device, "nvnBlendStateSetBlendEquation");
    pfncpp_nvnBlendStateSetAdvancedMode =
        (BlendStateSetAdvancedModeFunc)getProc(device, "nvnBlendStateSetAdvancedMode");
    pfncpp_nvnBlendStateSetAdvancedOverlap =
        (BlendStateSetAdvancedOverlapFunc)getProc(device, "nvnBlendStateSetAdvancedOverlap");
    pfncpp_nvnBlendStateSetAdvancedPremultipliedSrc =
        (BlendStateSetAdvancedPremultipliedSrcFunc)getProc(
    ...
    pfncpp_nvnBlendStateGetBlendTarget =
        (BlendStateGetBlendTargetFunc)getProc(device, "nvnBlendStateGetBlendTarget");
    pfncpp_nvnBlendStateGetBlendFunc =
        (BlendStateGetBlendFuncFunc)getProc(device, "nvnBlendStateGetBlendFunc");
    pfncpp_nvnBlendStateGetBlendEquation =
        (BlendStateGetBlendEquationFunc)getProc(device, "nvnBlendStateGetBlendEquation");
    pfncpp_nvnBlendStateGetAdvancedMode =
        (BlendStateGetAdvancedModeFunc)getProc(device, "nvnBlendStateGetAdvancedMode");
    pfncpp_nvnBlendStateGetAdvancedOverlap =
        (BlendStateGetAdvancedOverlapFunc)getProc(device, "nvnBlendStateGetAdvancedOverlap");
    pfncpp_nvnBlendStateGetAdvancedPremultipliedSrc =
        (BlendStateGetAdvancedPremultipliedSrcFunc)getProc(
    ...
    pfncpp_nvnColorStateSetDefaults =
        (ColorStateSetDefaultsFunc)getProc(device, "nvnColorStateSetDefaults");
    pfncpp_nvnColorStateSetBlendEnable =
        (ColorStateSetBlendEnableFunc)getProc(device, "nvnColorStateSetBlendEnable");
    pfncpp_nvnColorStateSetLogicOp =
        (ColorStateSetLogicOpFunc)getProc(device, "nvnColorStateSetLogicOp");
    pfncpp_nvnColorStateSetAlphaTest =
        (ColorStateSetAlphaTestFunc)getProc(device, "nvnColorStateSetAlphaTest");
    pfncpp_nvnColorStateGetBlendEnable =
        (ColorStateGetBlendEnableFunc)getProc(device, "nvnColorStateGetBlendEnable");
    pfncpp_nvnColorStateGetLogicOp =
        (ColorStateGetLogicOpFunc)getProc(device, "nvnColorStateGetLogicOp");
    pfncpp_nvnColorStateGetAlphaTest =
        (ColorStateGetAlphaTestFunc)getProc(device, "nvnColorStateGetAlphaTest");
    pfncpp_nvnChannelMaskStateSetDefaults =
        (ChannelMaskStateSetDefaultsFunc)getProc(device, "nvnChannelMaskStateSetDefaults");
    pfncpp_nvnChannelMaskStateSetChannelMask =
        (ChannelMaskStateSetChannelMaskFunc)getProc(device, "nvnChannelMaskStateSetChannelMask");
    pfncpp_nvnChannelMaskStateGetChannelMask =
        (ChannelMaskStateGetChannelMaskFunc)getProc(device, "nvnChannelMaskStateGetChannelMask");
    pfncpp_nvnMultisampleStateSetDefaults =
        (MultisampleStateSetDefaultsFunc)getProc(device, "nvnMultisampleStateSetDefaults");
    pfncpp_nvnMultisampleStateSetMultisampleEnable =
        (MultisampleStateSetMultisampleEnableFunc)getProc(
            device, "nvnMultisampleStateSetMultisampleEnable");
    pfncpp_nvnMultisampleStateSetSamples =
        (MultisampleStateSetSamplesFunc)getProc(device, "nvnMultisampleStateSetSamples");
    pfncpp_nvnMultisampleStateSetAlphaToCoverageEnable =
        (MultisampleStateSetAlphaToCoverageEnableFunc)getProc(
            device, "nvnMultisampleStateSetAlphaToCoverageEnable");
    pfncpp_nvnMultisampleStateSetAlphaToCoverageDither =
        (MultisampleStateSetAlphaToCoverageDitherFunc)getProc(
            device, "nvnMultisampleStateSetAlphaToCoverageDither");
    pfncpp_nvnMultisampleStateGetMultisampleEnable =
        (MultisampleStateGetMultisampleEnableFunc)getProc(
            device, "nvnMultisampleStateGetMultisampleEnable");
    pfncpp_nvnMultisampleStateGetSamples =
        (MultisampleStateGetSamplesFunc)getProc(device, "nvnMultisampleStateGetSamples");
    pfncpp_nvnMultisampleStateGetAlphaToCoverageEnable =
        (MultisampleStateGetAlphaToCoverageEnableFunc)getProc(
            device, "nvnMultisampleStateGetAlphaToCoverageEnable");
    pfncpp_nvnMultisampleStateGetAlphaToCoverageDither =
        (MultisampleStateGetAlphaToCoverageDitherFunc)getProc(
    ...
    pfncpp_nvnPolygonStateSetDefaults =
        (PolygonStateSetDefaultsFunc)getProc(device, "nvnPolygonStateSetDefaults");
    pfncpp_nvnPolygonStateSetCullFace =
        (PolygonStateSetCullFaceFunc)getProc(device, "nvnPolygonStateSetCullFace");
    pfncpp_nvnPolygonStateSetFrontFace =
        (PolygonStateSetFrontFaceFunc)getProc(device, "nvnPolygonStateSetFrontFace");
    pfncpp_nvnPolygonStateSetPolygonMode =
        (PolygonStateSetPolygonModeFunc)getProc(device, "nvnPolygonStateSetPolygonMode");
    pfncpp_nvnPolygonStateSetPolygonOffsetEnables =
        (PolygonStateSetPolygonOffsetEnablesFunc)getProc(device,
                                                         "nvnPolygonStateSetPolygonOffsetEnables");
    pfncpp_nvnPolygonStateGetCullFace =
        (PolygonStateGetCullFaceFunc)getProc(device, "nvnPolygonStateGetCullFace");
    pfncpp_nvnPolygonStateGetFrontFace =
        (PolygonStateGetFrontFaceFunc)getProc(device, "nvnPolygonStateGetFrontFace");
    pfncpp_nvnPolygonStateGetPolygonMode =
        (PolygonStateGetPolygonModeFunc)getProc(device, "nvnPolygonStateGetPolygonMode");
    pfncpp_nvnPolygonStateGetPolygonOffsetEnables =
        (PolygonStateGetPolygonOffsetEnablesFunc)getProc(device,
                                                         "nvnPolygonStateGetPolygonOffsetEnables");
    pfncpp_nvnDepthStencilStateSetDefaults =
        (DepthStencilStateSetDefaultsFunc)getProc(device, "nvnDepthStencilStateSetDefaults");
    pfncpp_nvnDepthStencilStateSetDepthTestEnable =
        (DepthStencilStateSetDepthTestEnableFunc)getProc(device,
                                                         "nvnDepthStencilStateSetDepthTestEnable");
    pfncpp_nvnDepthStencilStateSetDepthWriteEnable =
        (DepthStencilStateSetDepthWriteEnableFunc)getProc(
            device, "nvnDepthStencilStateSetDepthWriteEnable");
    pfncpp_nvnDepthStencilStateSetDepthFunc =
        (DepthStencilStateSetDepthFuncFunc)getProc(device, "nvnDepthStencilStateSetDepthFunc");
    pfncpp_nvnDepthStencilStateSetStencilTestEnable =
        (DepthStencilStateSetStencilTestEnableFunc)getProc(
            device, "nvnDepthStencilStateSetStencilTestEnable");
    pfncpp_nvnDepthStencilStateSetStencilFunc =
        (DepthStencilStateSetStencilFuncFunc)getProc(device, "nvnDepthStencilStateSetStencilFunc");
    pfncpp_nvnDepthStencilStateSetStencilOp =
        (DepthStencilStateSetStencilOpFunc)getProc(device, "nvnDepthStencilStateSetStencilOp");
    pfncpp_nvnDepthStencilStateGetDepthTestEnable =
        (DepthStencilStateGetDepthTestEnableFunc)getProc(device,
                                                         "nvnDepthStencilStateGetDepthTestEnable");
    pfncpp_nvnDepthStencilStateGetDepthWriteEnable =
        (DepthStencilStateGetDepthWriteEnableFunc)getProc(
            device, "nvnDepthStencilStateGetDepthWriteEnable");
    pfncpp_nvnDepthStencilStateGetDepthFunc =
        (DepthStencilStateGetDepthFuncFunc)getProc(device, "nvnDepthStencilStateGetDepthFunc");
    pfncpp_nvnDepthStencilStateGetStencilTestEnable =
        (DepthStencilStateGetStencilTestEnableFunc)getProc(
            device, "nvnDepthStencilStateGetStencilTestEnable");
    pfncpp_nvnDepthStencilStateGetStencilFunc =
        (DepthStencilStateGetStencilFuncFunc)getProc(device, "nvnDepthStencilStateGetStencilFunc");
    pfncpp_nvnDepthStencilStateGetStencilOp =
        (DepthStencilStateGetStencilOpFunc)getProc(device, "nvnDepthStencilStateGetStencilOp");
    pfncpp_nvnVertexAttribStateSetDefaults =
        (VertexAttribStateSetDefaultsFunc)getProc(device, "nvnVertexAttribStateSetDefaults");
    pfncpp_nvnVertexAttribStateSetFormat =
        (VertexAttribStateSetFormatFunc)getProc(device, "nvnVertexAttribStateSetFormat");
    pfncpp_nvnVertexAttribStateSetStreamIndex =
        (VertexAttribStateSetStreamIndexFunc)getProc(device, "nvnVertexAttribStateSetStreamIndex");
    pfncpp_nvnVertexAttribStateGetFormat =
        (VertexAttribStateGetFormatFunc)getProc(device, "nvnVertexAttribStateGetFormat");
    pfncpp_nvnVertexAttribStateGetStreamIndex =
        (VertexAttribStateGetStreamIndexFunc)getProc(device, "nvnVertexAttribStateGetStreamIndex");
    pfncpp_nvnVertexStreamStateSetDefaults =
        (VertexStreamStateSetDefaultsFunc)getProc(device, "nvnVertexStreamStateSetDefaults");
    pfncpp_nvnVertexStreamStateSetStride =
        (VertexStreamStateSetStrideFunc)getProc(device, "nvnVertexStreamStateSetStride");
    pfncpp_nvnVertexStreamStateSetDivisor =
        (VertexStreamStateSetDivisorFunc)getProc(device, "nvnVertexStreamStateSetDivisor");
    pfncpp_nvnVertexStreamStateGetStride =
        (VertexStreamStateGetStrideFunc)getProc(device, "nvnVertexStreamStateGetStride");
    pfncpp_nvnVertexStreamStateGetDivisor =
        (VertexStreamStateGetDivisorFunc)getProc(device, "nvnVertexStreamStateGetDivisor");
    pfncpp_nvnCommandBufferInitialize =
        (CommandBufferInitializeFunc)getProc(device, "nvnCommandBufferInitialize");
    pfncpp_nvnCommandBufferFinalize =
        (CommandBufferFinalizeFunc)getProc(device, "nvnCommandBufferFinalize");
    pfncpp_nvnCommandBufferSetDebugLabel =
        (CommandBufferSetDebugLabelFunc)getProc(device, "nvnCommandBufferSetDebugLabel");
    pfncpp_nvnCommandBufferSetMemoryCallback =
        (CommandBufferSetMemoryCallbackFunc)getProc(device, "nvnCommandBufferSetMemoryCallback");
    ...
    pfncpp_nvnCommandBufferAddCommandMemory =
        (CommandBufferAddCommandMemoryFunc)getProc(device, "nvnCommandBufferAddCommandMemory");
    pfncpp_nvnCommandBufferAddControlMemory =
        (CommandBufferAddControlMemoryFunc)getProc(device, "nvnCommandBufferAddControlMemory");
    ...
    pfncpp_nvnCommandBufferBeginRecording =
        (CommandBufferBeginRecordingFunc)getProc(device, "nvnCommandBufferBeginRecording");
    pfncpp_nvnCommandBufferEndRecording =
        (CommandBufferEndRecordingFunc)getProc(device, "nvnCommandBufferEndRecording");
    pfncpp_nvnCommandBufferCallCommands =
        (CommandBufferCallCommandsFunc)getProc(device, "nvnCommandBufferCallCommands");
    pfncpp_nvnCommandBufferCopyCommands =
        (CommandBufferCopyCommandsFunc)getProc(device, "nvnCommandBufferCopyCommands");
    pfncpp_nvnCommandBufferBindBlendState =
        (CommandBufferBindBlendStateFunc)getProc(device, "nvnCommandBufferBindBlendState");
    ...
    pfncpp_nvnCommandBufferBindColorState =
        (CommandBufferBindColorStateFunc)getProc(device, "nvnCommandBufferBindColorState");
    ...
    pfncpp_nvnCommandBufferBindPolygonState =
        (CommandBufferBindPolygonStateFunc)getProc(device, "nvnCommandBufferBindPolygonState");
    ...
    pfncpp_nvnCommandBufferBindProgram =
        (CommandBufferBindProgramFunc)getProc(device, "nvnCommandBufferBindProgram");
    pfncpp_nvnCommandBufferBindVertexBuffer =
        (CommandBufferBindVertexBufferFunc)getProc(device, "nvnCommandBufferBindVertexBuffer");
    pfncpp_nvnCommandBufferBindVertexBuffers =
        (CommandBufferBindVertexBuffersFunc)getProc(device, "nvnCommandBufferBindVertexBuffers");
    pfncpp_nvnCommandBufferBindUniformBuffer =
        (CommandBufferBindUniformBufferFunc)getProc(device, "nvnCommandBufferBindUniformBuffer");
    pfncpp_nvnCommandBufferBindUniformBuffers =
        (CommandBufferBindUniformBuffersFunc)getProc(device, "nvnCommandBufferBindUniformBuffers");
    pfncpp_nvnCommandBufferBindTransformFeedbackBuffer =
        (CommandBufferBindTransformFeedbackBufferFunc)getProc(
            device, "nvnCommandBufferBindTransformFeedbackBuffer");
    pfncpp_nvnCommandBufferBindTransformFeedbackBuffers =
        (CommandBufferBindTransformFeedbackBuffersFunc)getProc(
            device, "nvnCommandBufferBindTransformFeedbackBuffers");
    pfncpp_nvnCommandBufferBindStorageBuffer =
        (CommandBufferBindStorageBufferFunc)getProc(device, "nvnCommandBufferBindStorageBuffer");
    pfncpp_nvnCommandBufferBindStorageBuffers =
        (CommandBufferBindStorageBuffersFunc)getProc(device, "nvnCommandBufferBindStorageBuffers");
    pfncpp_nvnCommandBufferBindTexture =
        (CommandBufferBindTextureFunc)getProc(device, "nvnCommandBufferBindTexture");
    pfncpp_nvnCommandBufferBindTextures =
        (CommandBufferBindTexturesFunc)getProc(device, "nvnCommandBufferBindTextures");
    pfncpp_nvnCommandBufferBindImage =
        (CommandBufferBindImageFunc)getProc(device, "nvnCommandBufferBindImage");
    pfncpp_nvnCommandBufferBindImages =
        (CommandBufferBindImagesFunc)getProc(device, "nvnCommandBufferBindImages");
    pfncpp_nvnCommandBufferSetPatchSize =
        (CommandBufferSetPatchSizeFunc)getProc(device, "nvnCommandBufferSetPatchSize");
    pfncpp_nvnCommandBufferSetInnerTessellationLevels =
        (CommandBufferSetInnerTessellationLevelsFunc)getProc(
            device, "nvnCommandBufferSetInnerTessellationLevels");
    pfncpp_nvnCommandBufferSetOuterTessellationLevels =
        (CommandBufferSetOuterTessellationLevelsFunc)getProc(
    ...
    pfncpp_nvnCommandBufferBeginTransformFeedback =
        (CommandBufferBeginTransformFeedbackFunc)getProc(device,
    ...
    pfncpp_nvnCommandBufferPauseTransformFeedback =
        (CommandBufferPauseTransformFeedbackFunc)getProc(device,
                                                         "nvnCommandBufferPauseTransformFeedback");
    pfncpp_nvnCommandBufferResumeTransformFeedback =
        (CommandBufferResumeTransformFeedbackFunc)getProc(
    ...
    pfncpp_nvnCommandBufferDrawArrays =
        (CommandBufferDrawArraysFunc)getProc(device, "nvnCommandBufferDrawArrays");
    pfncpp_nvnCommandBufferDrawElements =
        (CommandBufferDrawElementsFunc)getProc(device, "nvnCommandBufferDrawElements");
    pfncpp_nvnCommandBufferDrawElementsBaseVertex =
        (CommandBufferDrawElementsBaseVertexFunc)getProc(device,
    ...
    pfncpp_nvnCommandBufferDrawArraysIndirect =
        (CommandBufferDrawArraysIndirectFunc)getProc(device, "nvnCommandBufferDrawArraysIndirect");
    ...
    pfncpp_nvnCommandBufferMultiDrawArraysIndirectCount =
        (CommandBufferMultiDrawArraysIndirectCountFunc)getProc(
            device, "nvnCommandBufferMultiDrawArraysIndirectCount");
    pfncpp_nvnCommandBufferMultiDrawElementsIndirectCount =
        (CommandBufferMultiDrawElementsIndirectCountFunc)getProc(
            device, "nvnCommandBufferMultiDrawElementsIndirectCount");
    pfncpp_nvnCommandBufferClearColor =
        (CommandBufferClearColorFunc)getProc(device, "nvnCommandBufferClearColor");
    pfncpp_nvnCommandBufferClearColori =
        (CommandBufferClearColoriFunc)getProc(device, "nvnCommandBufferClearColori");
    pfncpp_nvnCommandBufferClearColorui =
        (CommandBufferClearColoruiFunc)getProc(device, "nvnCommandBufferClearColorui");
    pfncpp_nvnCommandBufferClearDepthStencil =
        (CommandBufferClearDepthStencilFunc)getProc(device, "nvnCommandBufferClearDepthStencil");
    pfncpp_nvnCommandBufferDispatchCompute =
        (CommandBufferDispatchComputeFunc)getProc(device, "nvnCommandBufferDispatchCompute");
    pfncpp_nvnCommandBufferDispatchComputeIndirect =
        (CommandBufferDispatchComputeIndirectFunc)getProc(
            device, "nvnCommandBufferDispatchComputeIndirect");
    pfncpp_nvnCommandBufferSetViewport =
        (CommandBufferSetViewportFunc)getProc(device, "nvnCommandBufferSetViewport");
    pfncpp_nvnCommandBufferSetViewports =
        (CommandBufferSetViewportsFunc)getProc(device, "nvnCommandBufferSetViewports");
    ...
    pfncpp_nvnCommandBufferSetScissor =
        (CommandBufferSetScissorFunc)getProc(device, "nvnCommandBufferSetScissor");
    pfncpp_nvnCommandBufferSetScissors =
        (CommandBufferSetScissorsFunc)getProc(device, "nvnCommandBufferSetScissors");
    pfncpp_nvnCommandBufferSetDepthRange =
        (CommandBufferSetDepthRangeFunc)getProc(device, "nvnCommandBufferSetDepthRange");
    pfncpp_nvnCommandBufferSetDepthBounds =
        (CommandBufferSetDepthBoundsFunc)getProc(device, "nvnCommandBufferSetDepthBounds");
    pfncpp_nvnCommandBufferSetDepthRanges =
        (CommandBufferSetDepthRangesFunc)getProc(device, "nvnCommandBufferSetDepthRanges");
    ...
    pfncpp_nvnCommandBufferSetStencilMask =
        (CommandBufferSetStencilMaskFunc)getProc(device, "nvnCommandBufferSetStencilMask");
    pfncpp_nvnCommandBufferSetStencilRef =
        (CommandBufferSetStencilRefFunc)getProc(device, "nvnCommandBufferSetStencilRef");
    pfncpp_nvnCommandBufferSetBlendColor =
        (CommandBufferSetBlendColorFunc)getProc(device, "nvnCommandBufferSetBlendColor");
    pfncpp_nvnCommandBufferSetPointSize =
        (CommandBufferSetPointSizeFunc)getProc(device, "nvnCommandBufferSetPointSize");
    pfncpp_nvnCommandBufferSetLineWidth =
        (CommandBufferSetLineWidthFunc)getProc(device, "nvnCommandBufferSetLineWidth");
    ...
    pfncpp_nvnCommandBufferSetAlphaRef =
        (CommandBufferSetAlphaRefFunc)getProc(device, "nvnCommandBufferSetAlphaRef");
    pfncpp_nvnCommandBufferSetSampleMask =
        (CommandBufferSetSampleMaskFunc)getProc(device, "nvnCommandBufferSetSampleMask");
    ...
    pfncpp_nvnCommandBufferSetDepthClamp =
        (CommandBufferSetDepthClampFunc)getProc(device, "nvnCommandBufferSetDepthClamp");
    pfncpp_nvnCommandBufferSetConservativeRasterEnable =
        (CommandBufferSetConservativeRasterEnableFunc)getProc(
            device, "nvnCommandBufferSetConservativeRasterEnable");
    pfncpp_nvnCommandBufferSetConservativeRasterDilate =
        (CommandBufferSetConservativeRasterDilateFunc)getProc(
            device, "nvnCommandBufferSetConservativeRasterDilate");
    pfncpp_nvnCommandBufferSetSubpixelPrecisionBias =
        (CommandBufferSetSubpixelPrecisionBiasFunc)getProc(
    ...
    pfncpp_nvnCommandBufferCopyBufferToBuffer =
        (CommandBufferCopyBufferToBufferFunc)getProc(device, "nvnCommandBufferCopyBufferToBuffer");
    pfncpp_nvnCommandBufferClearBuffer =
        (CommandBufferClearBufferFunc)getProc(device, "nvnCommandBufferClearBuffer");
    pfncpp_nvnCommandBufferClearTexture =
        (CommandBufferClearTextureFunc)getProc(device, "nvnCommandBufferClearTexture");
    pfncpp_nvnCommandBufferClearTexturei =
        (CommandBufferClearTextureiFunc)getProc(device, "nvnCommandBufferClearTexturei");
    pfncpp_nvnCommandBufferClearTextureui =
        (CommandBufferClearTextureuiFunc)getProc(device, "nvnCommandBufferClearTextureui");
    ...
    pfncpp_nvnCommandBufferReportCounter =
        (CommandBufferReportCounterFunc)getProc(device, "nvnCommandBufferReportCounter");
    pfncpp_nvnCommandBufferResetCounter =
        (CommandBufferResetCounterFunc)getProc(device, "nvnCommandBufferResetCounter");
    pfncpp_nvnCommandBufferReportValue =
        (CommandBufferReportValueFunc)getProc(device, "nvnCommandBufferReportValue");
    pfncpp_nvnCommandBufferSetRenderEnable =
        (CommandBufferSetRenderEnableFunc)getProc(device, "nvnCommandBufferSetRenderEnable");
    pfncpp_nvnCommandBufferSetRenderEnableConditional =
        (CommandBufferSetRenderEnableConditionalFunc)getProc(
            device, "nvnCommandBufferSetRenderEnableConditional");
    pfncpp_nvnCommandBufferSetRenderTargets =
        (CommandBufferSetRenderTargetsFunc)getProc(device, "nvnCommandBufferSetRenderTargets");
    pfncpp_nvnCommandBufferDiscardColor =
        (CommandBufferDiscardColorFunc)getProc(device, "nvnCommandBufferDiscardColor");
    ...
    pfncpp_nvnCommandBufferDownsample =
        (CommandBufferDownsampleFunc)getProc(device, "nvnCommandBufferDownsample");
    pfncpp_nvnCommandBufferTiledDownsample =
        (CommandBufferTiledDownsampleFunc)getProc(device, "nvnCommandBufferTiledDownsample");
    ...
    pfncpp_nvnCommandBufferTiledDownsampleTextureView =
        (CommandBufferTiledDownsampleTextureViewFunc)getProc(
            device, "nvnCommandBufferTiledDownsampleTextureView");
    pfncpp_nvnCommandBufferBarrier =
        (CommandBufferBarrierFunc)getProc(device, "nvnCommandBufferBarrier");
    pfncpp_nvnCommandBufferWaitSync =
        (CommandBufferWaitSyncFunc)getProc(device, "nvnCommandBufferWaitSync");
    pfncpp_nvnCommandBufferFenceSync =
        (CommandBufferFenceSyncFunc)getProc(device, "nvnCommandBufferFenceSync");
    pfncpp_nvnCommandBufferSetTexturePool =
        (CommandBufferSetTexturePoolFunc)getProc(device, "nvnCommandBufferSetTexturePool");
    pfncpp_nvnCommandBufferSetSamplerPool =
        (CommandBufferSetSamplerPoolFunc)getProc(device, "nvnCommandBufferSetSamplerPool");
    pfncpp_nvnCommandBufferSetShaderScratchMemory =
        (CommandBufferSetShaderScratchMemoryFunc)getProc(device,
                                                         "nvnCommandBufferSetShaderScratchMemory");
    pfncpp_nvnCommandBufferSaveZCullData =
        (CommandBufferSaveZCullDataFunc)getProc(device, "nvnCommandBufferSaveZCullData");
    pfncpp_nvnCommandBufferRestoreZCullData =
        (CommandBufferRestoreZCullDataFunc)getProc(device, "nvnCommandBufferRestoreZCullData");
    pfncpp_nvnCommandBufferSetCopyRowStride =
        (CommandBufferSetCopyRowStrideFunc)getProc(device, "nvnCommandBufferSetCopyRowStride");
    pfncpp_nvnCommandBufferSetCopyImageStride =
        (CommandBufferSetCopyImageStrideFunc)getProc(device, "nvnCommandBufferSetCopyImageStride");
    pfncpp_nvnCommandBufferGetCopyRowStride =
        (CommandBufferGetCopyRowStrideFunc)getProc(device, "nvnCommandBufferGetCopyRowStride");
    pfncpp_nvnCommandBufferGetCopyImageStride =
        (CommandBufferGetCopyImageStrideFunc)getProc(device, "nvnCommandBufferGetCopyImageStride");
    pfncpp_nvnCommandBufferDrawTexture =
        (CommandBufferDrawTextureFunc)getProc(device, "nvnCommandBufferDrawTexture");
    pfncpp_nvnProgramSetSubroutineLinkage =
        (ProgramSetSubroutineLinkageFunc)getProc(device, "nvnProgramSetSubroutineLinkage");
    ...
    pfncpp_nvnCommandBufferBindCoverageModulationTable =
        (CommandBufferBindCoverageModulationTableFunc)getProc(
            device, "nvnCommandBufferBindCoverageModulationTable");
    pfncpp_nvnCommandBufferResolveDepthBuffer =
        (CommandBufferResolveDepthBufferFunc)getProc(device, "nvnCommandBufferResolveDepthBuffer");
    pfncpp_nvnCommandBufferSetColorReductionEnable =
        (CommandBufferSetColorReductionEnableFunc)getProc(
            device, "nvnCommandBufferSetColorReductionEnable");
    pfncpp_nvnCommandBufferSetColorReductionThresholds =
        (CommandBufferSetColorReductionThresholdsFunc)getProc(
    ...
    pfncpp_nvnCommandBufferPushDebugGroup =
        (CommandBufferPushDebugGroupFunc)getProc(device, "nvnCommandBufferPushDebugGroup");
    pfncpp_nvnCommandBufferPopDebugGroup =
        (CommandBufferPopDebugGroupFunc)getProc(device, "nvnCommandBufferPopDebugGroup");
    pfncpp_nvnCommandBufferPopDebugGroupId =
        (CommandBufferPopDebugGroupIdFunc)getProc(device, "nvnCommandBufferPopDebugGroupId");
    pfncpp_nvnCommandBufferInsertDebugMarkerStatic =
        (CommandBufferInsertDebugMarkerStaticFunc)getProc(
            device, "nvnCommandBufferInsertDebugMarkerStatic");
    pfncpp_nvnCommandBufferInsertDebugMarkerDynamic =
        (CommandBufferInsertDebugMarkerDynamicFunc)getProc(
            device, "nvnCommandBufferInsertDebugMarkerDynamic");
    pfncpp_nvnCommandBufferInsertDebugMarker =
        (CommandBufferInsertDebugMarkerFunc)getProc(device, "nvnCommandBufferInsertDebugMarker");
    pfncpp_nvnCommandBufferGetMemoryCallback =
        (CommandBufferGetMemoryCallbackFunc)getProc(device, "nvnCommandBufferGetMemoryCallback");
    ...
    pfncpp_nvnCommandBufferIsRecording =
        (CommandBufferIsRecordingFunc)getProc(device, "nvnCommandBufferIsRecording");
    ...
    pfncpp_nvnEventBuilderSetDefaults =
        (EventBuilderSetDefaultsFunc)getProc(device, "nvnEventBuilderSetDefaults");
    pfncpp_nvnEventBuilderSetStorage =
        (EventBuilderSetStorageFunc)getProc(device, "nvnEventBuilderSetStorage");
    pfncpp_nvnEventBuilderGetStorage =
        (EventBuilderGetStorageFunc)getProc(device, "nvnEventBuilderGetStorage");
    ...
    pfncpp_nvnCommandBufferWaitEvent =
        (CommandBufferWaitEventFunc)getProc(device, "nvnCommandBufferWaitEvent");
    pfncpp_nvnCommandBufferSignalEvent =
        (CommandBufferSignalEventFunc)getProc(device, "nvnCommandBufferSignalEvent");
    pfncpp_nvnCommandBufferSetStencilCullCriteria =
        (CommandBufferSetStencilCullCriteriaFunc)getProc(device,
